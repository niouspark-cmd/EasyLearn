...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-lexend flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] bg-teal-500/10 rounded-full blur-[100px]"></div>
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center mb-6">
            <div className="relative">
                ...
                <div className="relative w-16 h-16 bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl flex items-center justify-center text-white font-bold text-3xl shadow-2xl border border-indigo-500/30">
                  <span className="font-outfit">A</span>
                </div>
            </div>
          </div>
          <h1 className="text-3xl font-bold text-white mb-3 font-outfit">Welcome to your Lab.</h1>
          <p className="text-indigo-200 text-lg">Your journey to mastering sounds starts here.<br/>Private. Simple. Powerful.</p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl p-8 rounded-[32px] shadow-2xl border border-indigo-500/20">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
               ...
               <span className="text-indigo-300 text-sm">or access with PIN</span>
               <div className="h-[1px] flex-1 bg-indigo-900"></div>
            </div>

            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-indigo-300 ml-1">Your Access Number</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-indigo-300 ml-1">4-Digit Lab PIN</label>
                <div className="relative group">
                  <div className="absolute inset-0 bg-indigo-500/20 rounded-2xl blur-sm opacity-0 group-focus-within:opacity-100 transition-opacity"></div>
            ...
            <button type="submit" className="w-full py-4 bg-teal-500 hover:bg-teal-400 text-slate-900 font-bold rounded-2xl shadow-lg shadow-teal-500/20 flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all text-lg font-outfit">
          ...
          <div className="mt-8 text-center">
            <p className="text-indigo-400 text-sm">
              New Researcher? <Link to="/register" className="text-teal-400 font-bold hover:text-teal-300 transition-colors">Join the Lab</Link>
            </p>
          </div>
        </div>
      </div>
